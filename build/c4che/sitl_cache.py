...
CXX_TGT_F = ['-c', '-o']
DEBUG = False
DEFINES = ['SKETCHBOOK="/home/lol/research/ardupilot"', 'CONFIG_HAL_BOARD=HAL_BOARD_SITL', 'CONFIG_HAL_BOARD_SUBTYPE=HAL_BOARD_SUBTYPE_NONE']
DEFINES_ST = '-D%s'
...
TOOLCHAIN = 'native'
cfg_files = ['/home/lol/research/ardupilot/build/sitl/ap_config.h']
cprogram_PATTERN = '%s'
